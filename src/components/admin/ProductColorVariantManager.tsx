                    ...
                    {variant.options.map((option, optionIndex) => (
                      <div key={optionIndex} className="grid grid-cols-5 gap-2 items-center p-2 border rounded">
                        ...
                        <Input
                          type="number"
                          value={option.price}
                          onChange={(e) => handleOptionChange(variantIndex, optionIndex, 'price', Number(e.target.value))}
                          placeholder="السعر"
                          min="0"
                          step="0.01"
                          size="sm"
                        ...
                        <Input
                          type="number"
                          value={option.stock}
                          onChange={(e) => handleOptionChange(variantIndex, optionIndex, 'stock', Number(e.target.value))}
                          placeholder="الكمية"
                          min="0"
                          size="sm"
                          required
