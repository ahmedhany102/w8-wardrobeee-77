...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer className="bg-gray-900 text-white py-4 mt-auto w-full flex flex-col justify-end min-h-[120px]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            <div className="text-center md:text-left">
              <h3 className="text-base font-semibold mb-1">W8</h3>
              <p className="text-xs text-gray-300">
                Your one-stop shop for quality products in Egypt
              </p>
              <p className="text-xs mt-1">
                &copy; {new Date().getFullYear()} W8. All rights reserved.
              </p>
              <p className="text-xs mt-0 text-green-400">
                Dev Ahmed Hany
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center md:justify-start gap-1 mb-1">
                ...
                <a href="tel:01501640040" className="text-xs text-gray-300 hover:text-white">
                  01501640040
                </a>
              </div>
              <div className="flex items-center justify-center md:justify-start gap-1">
                <Mail className="h-3 w-3 text-green-400" />
                <a href="mailto:support@w8.com" className="text-xs text-gray-300 hover:text-white">
                  support@w8.com
                </a>
              </div>
            </div>
