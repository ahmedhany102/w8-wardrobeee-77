    ...
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {!isLoginPage && (
        <footer className="mt-auto w-full">
          <Footer />
          {user && !isAdminPage && (
            <nav className="w-full bg-gradient-to-r from-green-900 to-black z-40 border-t border-green-800 py-1">
  ...
  return (
    <Link
      ...
      className={`flex flex-col items-center justify-center px-2 py-1 rounded-lg transition-colors ${
        isActive ? 'text-green-300' : 'text-gray-300 hover:text-green-100'
      }`}
    >
      {icon}
